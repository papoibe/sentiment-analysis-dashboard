...
/**
 * Global Exception Handler - Format thống nhất (error, message, details, path,
 * timestamps)
 */
@RestControllerAdvice
public class GlobalExceptionHandl {

    private static final Logger log = LoggerFactory.getLogger(GlobalExceptionHandl.class);
